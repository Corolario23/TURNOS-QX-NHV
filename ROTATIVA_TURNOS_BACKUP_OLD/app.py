...
<body>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <input type="text" id="cirujano1" placeholder="Cirujano 1">
            <input type="text" id="cirujano2" placeholder="Cirujano 2">
                    ...
                    <div class="dia">
                        ...
                        {% if fecha in calendarios[año] %}
                            <div class="turno-info" 
                                 onclick="editarTurno('{{ fecha }}', '{{ calendarios[año][fecha].cirujanos[0] }}', '{{ calendarios[año][fecha].cirujanos[1] }}')"
    ...
    <script>
        ...
        function editarTurno(fecha, cirujano1, cirujano2) {
